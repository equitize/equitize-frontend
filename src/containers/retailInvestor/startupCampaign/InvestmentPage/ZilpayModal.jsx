...
function ZilpayModal({ getInvestmentData, redirectForTransactionSuccess }){
    ...
    const [zilPayCheck, setZilPayCheck] = useState(undefined);
    ...
    const connectZilPay = async () => {
        setLoading(true)
        const isConnect = await zilPay.wallet.connect();
    ...
    return (
        <>
            <PrimaryButton text="Submit" properties="self-end" onClick={ModalFunc} />
            {showModal ? (
                                ...
                                <div className="p-6 flex flex-wrap align-middle justify-items-center flex-col w-full">
                                    {
                                        loading ?
                                            ...
                                            : isConnect ?
                                                transition ?
                                                    <>
                                                        <div className="flex flex-col justify-center items-center justify-items-center w-full space-y-3">
                                                            <p className="font-Inter text-xl">You are connected to</p>
                                                            <div className="flex flex-row space-x-4">
                                                                ...
                                                                <p className="font-Inter text-2xl font-bold align-middle">ZilPay</p>
                                                            </div>
                                            ...
                                            <>
                                                <div className="flex flex-row justify-between items-center w-full space-x-4 border-2 border-gray-700 rounded-xl md:p-10">
                                                    ...
                                                    <p className="text-center align-middle font-Rubik font-bold text-xl">Zilpay</p>
                                                    <PrimaryButton text="Connect Zilpay" onClick={connectZilPay}/>
                                                </div>
                                            </>
                                    }
                                </div>
