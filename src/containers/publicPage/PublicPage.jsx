        ...
        <div className="flex flex-wrap flex-col items-center justify-between w-full">
            ...
            <div className="flex flex-col bg-secondary w-full items-center space-y-10 px-4 py-6">
                ...
                <div className="flex flex-row flex-wrap text-white w-full px-4 gap-y-5">
                    <div className="flex flex-col md:w-1/2 lg:w-1/4 space-y-3" >
            ...
            <div className="flex flex-col bg-primary w-full items-center space-y-10 px-4">
                <div className="flex flex-col w-full items-center space-y-10 sm:p-4">
                    <br/>
                ...
                <Link className="self-end px-10" to="/register">
